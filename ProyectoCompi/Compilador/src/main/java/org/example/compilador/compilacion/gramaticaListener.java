...
public interface gramaticaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link gramaticaParser#cont}.
	 * @param ctx the parse tree
	 */
	void enterCont(gramaticaParser.ContContext ctx);
	/**
	 * Exit a parse tree produced by {@link gramaticaParser#cont}.
	 * @param ctx the parse tree
	 */
	void exitCont(gramaticaParser.ContContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link gramaticaParser#newcont}.
	 * @param ctx the parse tree
	 */
	void enterNewcont(gramaticaParser.NewcontContext ctx);
	/**
	 * Exit a parse tree produced by {@link gramaticaParser#newcont}.
	 * @param ctx the parse tree
	 */
	void exitNewcont(gramaticaParser.NewcontContext ctx);
	/**
