...
public interface gramaticaVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link gramaticaParser#cont}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by {@link gramaticaParser#newcont}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNewcont(gramaticaParser.NewcontContext ctx);
	/**
