...
public interface SimpleVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SimpleParser#comments}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitComments(SimpleParser.CommentsContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SimpleParser#repeadtcond}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRepeadtcond(SimpleParser.RepeadtcondContext ctx);
	/**
